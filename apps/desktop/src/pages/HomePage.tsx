...
const SUGGESTIONS = [
  ...
  },
  {
    ...
    prompt:
      "Create a subject-specific PowerPoint presentation. Plan the deck first, then author a deck-specific HTML/CSS slide system so the preview and downloaded PPTX come from the same slide design. Use deck.cover_html for the cover and authored HTML for every content slide. Do not use a fixed template, do not reuse an old cover pattern, keep the deck refined and contemporary instead of dated corporate slideware, and use one coherent deck system across all slides. Compose with the modern Bootstrap-compatible grid/component kit: container-fluid, rows, columns, cards, list groups, badges, display typography, and Bootstrap Icons placeholders such as <i class=\"bi bi-graph-up-arrow\" aria-hidden=\"true\"></i>. Do not generate SVG icons and do not use emoji anywhere in visible slide copy. Use charts, timelines, comparisons, or tables only where they improve the slide, and build dense, well-framed slide compositions instead of airy browser mockups or giant outer padding wrappers.",
  },
  {
