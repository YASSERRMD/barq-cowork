...
const SUGGESTIONS = [
  ...
  },
  {
    ...
    prompt:
      "Create a subject-specific PowerPoint presentation. Plan the full deck first, choose the visual style, cover style, and color story from the subject, vary slide types, and use real icons, charts, timelines, comparisons, or tables only where they improve the slide.",
  },
  {
